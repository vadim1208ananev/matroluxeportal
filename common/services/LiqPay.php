...
class LiqPay
{
    ...
    public $_api_url = 'https://www.liqpay.ua/api';
    public $_checkout_url = 'https://www.liqpay.ua/api/3/checkout';
    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form method="POST" action="%s" accept-charset="utf-8">
                %s
                %s
                <button class="button is-primary" name="btn_text">Оплатить</button>
            </form>
            ',
            $this->_checkout_url,
    ...
    public function check_signature($str)
    {
        return $this->str_to_sign($this->_private_key . $str . $this->_private_key);
    }
